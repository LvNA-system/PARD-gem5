...
#define CPA_IOCSENTRY	_IOW(CPA_IOC_MAGIC, 1, struct cp_ioctl_args_t)
#define CPA_IOCGENTRY	_IOR(CPA_IOC_MAGIC, 2, struct cp_ioctl_args_t)
#define CPA_IOCCMD      _IOW(CPA_IOC_MAGIC, 3, struct cp_ioctl_args_t)
