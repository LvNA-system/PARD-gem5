...
extern int __cpa_ioctl_getentry(struct control_plane_device *,
                                struct cpa_ioctl_args_t *);
extern int __cpa_ioctl_setentry(struct control_plane_device *,
                                const struct cpa_ioctl_args_t *);
...
void generic_cp_probe(struct control_plane_device *cp, void *cp_args)
{
    int ret;
    struct cpa_ioctl_args_t args;
    struct generic_control_plane_extra *extra =
        (struct generic_control_plane_extra *)cp_args;
...
void generic_cp_remove(struct control_plane_device *cp)
{
    struct ldom_obj *ldom;
